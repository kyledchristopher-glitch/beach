    ...
    <main className={styles.pageShell}>
      <section ref={sceneRef} className={styles.scene} aria-label="Cinematic beach sunset to night scroll scene">
        ...
        <div ref={copyRef} className={styles.copyBlock}>
          <p className={styles.eyebrow}>A Moment Suspended</p>
          <h1>Where Day Surrenders</h1>
          <p className={styles.bodyCopy}>Let the horizon take the light, and the stars remember the rest.</p>
        </div>
